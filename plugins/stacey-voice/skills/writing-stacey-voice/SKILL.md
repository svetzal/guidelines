---
name: writing-stacey-voice
description: >
  Stacey Vetzal's blog writing voice and style guide. Use this skill whenever writing blog posts,
  articles, or long-form content for Stacey Vetzal, stacey.vetzal.com, or "Stacey on Software".
  Also use when the user asks to write in Stacey's voice, draft a post, ghostwrite for Stacey,
...
# Writing in Stacey Vetzal's Voice
...
- First-person pronouns ("I", "we") appear at least 2x as often as third-person ones.
