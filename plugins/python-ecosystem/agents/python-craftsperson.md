...
description: |
  Use this agent when writing, reviewing, refactoring, or maintaining Python code that requires production-grade quality, comprehensive testing, and adherence to engineering best practices. Specifically invoke this agent when:
