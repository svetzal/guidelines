...
description: |
  Use this agent when working with Go code in any capacity - implementing new features, refactoring existing code, reviewing pull requests, debugging issues, or ensuring code quality and security. This includes:
