#!/usr/bin/env python3
"""Validator for craftsperson/rust/use-structured-tracing.

Production code emits tracing events with named fields and contains no print
macros.
...
INTENT = "craftsperson/rust/use-structured-tracing"
LANGUAGE = "rust"
