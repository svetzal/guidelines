#!/usr/bin/env python3
"""Validator for craftsperson/rust/prefer-fakes-at-boundaries.

Tests substitute a collaborator by implementing a project-owned trait with an
in-memory fake rather than intercepting library internals.
...
INTENT = "craftsperson/rust/prefer-fakes-at-boundaries"
LANGUAGE = "rust"
