#!/usr/bin/env python3
"""Validator for craftsperson/python/immutable-domain-models.

Every Pydantic model, dataclass, or NamedTuple in production code is declared
frozen.
...
INTENT = "craftsperson/python/immutable-domain-models"
LANGUAGE = "python"
