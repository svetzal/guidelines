#!/usr/bin/env python3
"""Validator for craftsperson/python/isolated-async-tests.

Async test functions exist, pytest declares `asyncio_mode` or the tests carry
an asyncio or anyio marker, and an async test runner is declared as a
dependency.
...
INTENT = "craftsperson/python/isolated-async-tests"
LANGUAGE = "python"
