#!/usr/bin/env python3
"""Validator for craftsperson/python/nonblocking-async-io.

Production code defines async functions that await, and no configured blocking
call runs inside an async function unless it is delegated to an executor.
