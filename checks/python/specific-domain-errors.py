#!/usr/bin/env python3
"""Validator for craftsperson/python/specific-domain-errors.

Production code defines named exception classes and contains no bare `except`
clause and no `raise Exception(...)`.
...
INTENT = "craftsperson/python/specific-domain-errors"
LANGUAGE = "python"
