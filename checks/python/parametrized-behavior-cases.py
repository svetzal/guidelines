#!/usr/bin/env python3
"""Validator for craftsperson/python/parametrized-behavior-cases.

At least one test carries a `pytest.mark.parametrize` decorator supplying its
case data.
...
INTENT = "craftsperson/python/parametrized-behavior-cases"
LANGUAGE = "python"
